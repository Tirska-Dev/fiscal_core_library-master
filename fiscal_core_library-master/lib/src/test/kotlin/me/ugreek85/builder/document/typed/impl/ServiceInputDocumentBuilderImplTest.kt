...
internal class ServiceInputDocumentBuilderImplTest {
    ...
    {
        assertEquals(document.getDocumentType(), DocumentType.ServiceInput)
        assertEquals(document.getDocumentHeader().getInternalDocumentType(), InternalDocumentType.SALE)
        assertEquals(document.getDocumentHeader().getInternalDocumentSubType(), InternalDocumentSubType.SERVICE_DEPOSIT)
    ...
    fun buildOnlineDocument() {
        ...
        val builder = TypedDocumentBuilderFactoryImpl
            .newInstance()
            .newServiceInputDocumentBuilder()
        ...
        assertEquals(document.getDocumentName(), "ServiceInput")
    ...
    fun buildOfflineDocument() {
        ...
        assertEquals(document.getDocumentName(), "OfflineServiceInput")
